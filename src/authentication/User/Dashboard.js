...
const Dashboard = () => {
    ...
    const fetchDashboardStats = async () => {
        ...
        try {
            ...
            const addressesResponse = await fetch('http://localhost:8000/api/orders/addresses/', {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
    ...
    const fetchCancelledRefundedOrders = async () => {
        ...
        try {
            const token = localStorage.getItem('token');
            const response = await fetch('http://localhost:8000/api/orders/cancelled-refunded/', {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
    ...
    const updateAddress = async (e) => {
        ...
        try {
            const token = localStorage.getItem('token');
            const response = await fetch(`http://localhost:8000/api/orders/addresses/${editingAddress.id}/`, {
                method: 'PUT',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
    ...
    const deleteAddress = async () => {
        ...
        try {
            const token = localStorage.getItem('token');
            const response = await fetch(`http://localhost:8000/api/orders/addresses/${addressToDelete.id}/`, {
                method: 'DELETE',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
    ...
    const confirmCancelOrder = async () => {
        ...
        try {
            const token = localStorage.getItem('token');
            const response = await fetch(`http://localhost:8000/api/orders/${orderToCancel.id}/cancel/`, {
                method: 'PATCH',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
    ...
    const setDefaultAddress = async (addressId) => {
        try {
            const token = localStorage.getItem('token');
            const response = await fetch(`http://localhost:8000/api/orders/addresses/${addressId}/set-default/`, {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
